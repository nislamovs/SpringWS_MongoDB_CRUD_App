...
import localhost._8082.api.v1.ws.persons.GetPersonsRequest;
import localhost._8082.api.v1.ws.persons.GetPersonsResponse;
...
public class PersonsEndpoint {
	...
	private static final String NAMESPACE_URI = "http://localhost:8082/api/v1/ws/persons";
